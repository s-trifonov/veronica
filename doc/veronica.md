...
Вариант: инсталляция Python3 производится специально для использования данной программы Вероника. В этом случае установка пакетов (pip install -r ...), см. ниже, выполняется без виртуального окружения, прямо вовнутрь инсталляции Питона.) 
